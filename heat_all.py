...
if __name__ == "__main__":
    ...
    datadir = "/cluster/home/ammaa/Downloads/Ammars/Models/PIM/FGVC-Multi/wrist_data/test/1"
    for file in os.listdir(datadir):
        ...
        rgb_img = cv2.imread(os.path.join(datadir, file))
        ...
        if args.save_img != "":
            # cv2.imwrite(args.save_img + f"/heatmap.jpg", heatmap)
            # cv2.imwrite(args.save_img + "/rbg_img.jpg", rgb_img)
            cv2.imwrite(args.save_img + f"{file}", mix)
