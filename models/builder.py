...
def build_resnet50(pretrained: str = "/cluster/home/ammaa/Downloads/Ammars/Models/PIM/FGVC-PIM/models/resnet50_miil_21k.pth",
...
def build_resnest(return_nodes: Union[dict, None] = None,
                   num_selects: Union[dict, None] = None, 
                   img_size: int = 448,
                   use_fpn: bool = True,
                   fpn_size: int = 512,
    ...
    backbone = timm.create_model('resnest101e', pretrained=True, num_classes=4)
...
def build_swintransformer(pretrained: bool = True,
    ...
    # backbone = load_model_weights(backbone, '/cluster/home/ammaa/Downloads/Ammars/Models/TIMM/TIMM2/m.pth')
    # print(backbone)
    # print(get_graph_node_names(backbone))
    backbone.train()
